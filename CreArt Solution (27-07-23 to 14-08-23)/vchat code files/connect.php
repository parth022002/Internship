        ...
        <div class="pop-up flex justify-between w-96 bg-white rounded overflow-hidden">
            ...
            <div class="flex items-center justify-center mx-4">
                <ul class="flex pr-2">
                    ...
                    <li>
                        <button id="answerBtn"
                            class="hover:text-green-700 transition text-green-600 px-4 py-1 text-xl ">
        ...
        <div class="inner flex bg-white w-4/5 border" style="height:70%; margin-bottom:10%;">
                    ...
                    <div class="flex justify-between items-center border-b">
                        <div class="mx-2 flex items-center justify-center">
                            <div class="flex-shrink-0 mx-2 my-4 rounded-full overflow-hidden h-12 w-12  cursor-pointer">
                                <img class="w-full h-auto rounded-full select-none"
                        ...
                        <div class="flex items-center mx-4">
                            ...
                            <span
                                class="menu-logout relative select-none transition hover:text-gray-500 mx-3 text-gray-600 cursor-pointer">
                                <i class="fas fa-ellipsis-v"></i>
                                <div class="logout flex items-center justify-center rounded absolute right-0 top-2 bg-white border hover:bg-gray-200"
                                    style="width: 100px;height: 60px;">
                                    <a href="logout.php" class="p-2 px-2 text-lg text-gray-600">Logout</a>
                                </div>
                            </span>
                        </div>
                    </div>
                    <div class="px-6 py-5 select-none">
                        <input class="p-2 w-full rounded border" type="text" name="usersearch"
            ...
            <div class="flex-2 flex rounded-xl w-full h-full ">
                ...
                <div id="profile" class="flex flex-1 justify-center items-center">
                    <div
                        class="flex flex-col flex-1 h-full overflow-hidden overflow-y-auto items-center justify-center">
                        ...
                        <div class="right-heading">
                            ...
                            <button id="callBtn" data-user="<?php echo $profileData->userID; ?>"
                                class="active:-top-2 relative transition border border-gray-400 shadow-md my-4 bg-green-400 hover:bg-green-500 p-4 px-5 rounded-full text-white text-xl">
                                <i class="fas fa-video"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div id="video" class="hidden overflow-hidden flex items-center">
                    <div class="flex relative flex-col h-full">
                        <div class="order-2 h-full">
                            <video id="remoteVideo" class="h-full object-cover" style="width:1280px;" autoplay
                                playinline></video>
                            <video id="localVideo" class="vid-2 z-1 right-0 bottom-1 absolute" autoplay
                                playinline></video>
                        </div>
                        <div class="order-1 mt-4 absolute self-center">
                            <div class="time rounded-xl text-white font-bold py-1 px-4"><span id="callTimer"></span>
                            </div>
                        </div>
                        <div
                            class="order-3 shadow-md flex justify-center btn-call-end items-end w-full h-full absolute ">
                            <button id="hangupBtn"
