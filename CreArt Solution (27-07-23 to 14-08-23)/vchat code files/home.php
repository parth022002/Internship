        ...
        <div class="inner flex bg-white w-4/5 border" style="height:70%; margin-bottom:10%;">
                ...
                <div class="h-full overflow-hidden">
                    <div class="flex justify-between items-center border-b">
                        ...
                        <div class="flex items-center mx-4">
                            <span class="select-none transition mx-3 text-green-400 cursor-pointer"><i
                                    class="fas fa-circle"></i></span>
                            <span
                                class="select-none transition hover:text-gray-500 mx-3 text-gray-600 cursor-pointer"><i
                                    class="fas fa-comment-alt"></i></span>
                            <span
                                class="menu-logout relative select-none transition hover:text-gray-500 mx-3 text-gray-600 cursor-pointer"><i
            ...
            <div class="flex-2 flex rounded-xl w-full h-full ">
                ...
                <div class=" flex flex-1 justify-center items-center">
                    <div
                        class="select-none flex flex-col flex-1 h-full overflow-hidden overflow-y-auto items-center justify-center">
